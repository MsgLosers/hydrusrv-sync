...
module.exports = {
  hydrusrvContentDbPath: process.env.HYDRUSRV_CONTENT_DB_PATH,
  hydrusServerDbPath: process.env.HYDRUS_SERVER_DB_PATH,
  hydrusMasterDbPath: process.env.HYDRUS_MASTER_DB_PATH,
  hydrusMappingsDbPath: process.env.HYDRUS_MAPPINGS_DB_PATH,
